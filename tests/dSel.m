...
m = 25; n = 50; k = 5; % m rows, n cols, k nonzeros.
...
fprintf('one norm of SPGL1: %5.3f, one-norm of P-Dantzig: %5.3f\n', norm(xGN, 1), norm(xCVX, 1));

fprintf('norm diff between CVX and SPGL1: %5.3f \n', norm(xGN - xCVX, inf));
